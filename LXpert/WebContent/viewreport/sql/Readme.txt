...
Business Objects Support - jrc_resultset_datasource
...
This sample demonstrates how to push a runtime Java Resultset to a 
...
jrc_resultset_datasource.jsp 
jrc_resultset_datasource.rpt
...
3. In a browser window, launch the file jrc_resultset_datasource.jsp as follows: 

http://<computer name>:<port number>/<web app>/jrc_resultset_datasource.jsp 
